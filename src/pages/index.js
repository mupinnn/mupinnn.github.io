        ...
        <Layout>
            ...
            <div className="w-full mt-5">
                ...
                <p className="mb-3 text-sm md:text-base">
                    Welcome to my website. You can know me more through this
                ...
                <p className="mb-3 text-sm md:text-base">
                    ...
                    that have NES-styles interface and some pre-built component
                    to help you create a website with pixelated/NES-styled. So,
                    I decided to use it on my portfolio website.
                </p>
            </div>
        </Layout>
    );
