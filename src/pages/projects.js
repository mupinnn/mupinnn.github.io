                    ...
                    <div className="pb-4 border-dashed border-b-2 border-black md:pl-4 md:border-l-2 md:col-span-6">
                        <div>
                            ...
                            <p className="mb-3 text-sm md:text-base">
                                Minimalist, responsive blog theme for Tailwind
                                CSS
                            </p>
                            <p className="mb-3 text-sm md:text-base">
                ...
                <div className="grid auto-rows-fr gap-4 md:grid-cols-8">
                    ...
                    <div className="pb-4 border-dashed border-b-2 border-black md:pl-4 md:border-l-2 md:col-span-6">
                        <div>
                            ...
                            <p className="mb-3 text-sm md:text-base">
                                I do a lot of fun work here and also learned a
                                lot as a Front-End Engineer.
                            </p>
                            <p className="mb-3 text-sm md:text-base">
                                Tech : React, Redux, SCSS, NextJS, Directus,
                                Socket.io, CSS Animation
                            </p>
                        </div>
                        <a
